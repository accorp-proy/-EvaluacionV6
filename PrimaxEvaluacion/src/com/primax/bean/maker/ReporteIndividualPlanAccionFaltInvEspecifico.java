...
public class ReporteIndividualPlanAccionFaltInvEspecifico extends BaseReport {
	...
	public ByteArrayOutputStream getReport(Map<String, String[]> params, String localPath, ServletContext servlet,
		...
		try {
			...
			JasperPrint jprint = JasperFillManager.fillReport(
					localPath + File.separator + "planAccion" + File.separator + "rptPlanAccionFaltanteInv.jasper",
					paramRpt, cn);
