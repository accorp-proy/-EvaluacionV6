...
public class ReporteGrupalFaltanteInventario extends BaseReport {
	...
	public ByteArrayOutputStream getReport(Map<String, String[]> params, String localPath, ServletContext servlet,
		...
		try {
			...
			if (isexcel) {
				nombreReporte = "rptFaltanteInventarioExcel.jasper";
			} else {
				nombreReporte = "rptFaltanteInventarioPdf.jasper";
			}
		} catch (Exception e) {
			e.printStackTrace();
