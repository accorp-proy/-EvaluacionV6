				...
				public void loadEvents(LocalDateTime desde, LocalDateTime hasta) {
					try {
						...
						for (PlanAccionInventarioEt planificacion : planAccionIventarios) {
							...
							estado = "ESTADO:" + " " + planificacion.getEstadoPlanAccionInv().getDescripcion()
									+ "<br/>";
							estacion = planificacion.getPlanificacionInventario().getAgencia().getNombreAgencia()
									+ "<br/>";
...
//	}
	...
	public void onEventSelect(SelectEvent selectEvent) {
		...
		planAccionInvSeleccionado = iPlanAccionInventarioDao
				.getPlanAccionInventarioById(planificacion.getIdPlanAccionInventario());
	...
	public void redireccionar() {
		...
		try {
			...
			List<PlanAccionInventarioEt> planAccionInventarios = iPlanAccionInventarioDao
					.getPlanAccionInvByAgencia(responsable.getAgencia());
			...
			for (PlanAccionInventarioTipoEt tipoInv : tipoInventarioSeleccionados) {
				PlanAccionInventarioTipoEt tipo = iPlanAccionInventarioTipoDao
						.getPlanAccionInv(planAccionInvSeleccionado, tipoInv.getTipoInventario());
			...
			pagina = "/PrimaxEvaluacion/pages/gerencia/ger_004.xhtml";
