...
@Named("ConsultaPlanAccionFaltanteInvBn")
@ViewScoped
public class ConsultaPlanAccionFaltanteInvBean extends BaseBean implements Serializable {
	...
	@EJB
	private IFaltanteInventarioDao iFaltanteInventarioDao;
	...
	private List<FaltanteInventarioEt> checkListEjecuciones;
	...
	public void buscar() {
		try {
			...
			if (usuario.isAccesoZona()) {
				checkListEjecuciones = iFaltanteInventarioDao.getCheckListEjecucionAccesoZonaListPlanAccionFaltInv(
						estacionSeleccionada, evaluacionSeleccionada, fDesde, fHasta, estadoPlanAccionSeleccionado,
						usuario, usuario);
			} else {
				checkListEjecuciones = iFaltanteInventarioDao
						.getCheckListEjecucionAccesoZonaListPlanAccionFaltInventario(estacionSeleccionada,
								evaluacionSeleccionada, fDesde, fHasta, estadoPlanAccionSeleccionado, usuario);
			}
	...
	public List<FaltanteInventarioEt> getCheckListEjecuciones() {
		return checkListEjecuciones;
	}

	public void setCheckListEjecuciones(List<FaltanteInventarioEt> checkListEjecuciones) {
