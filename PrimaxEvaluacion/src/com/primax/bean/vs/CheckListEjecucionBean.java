...
public class CheckListEjecucionBean extends BaseBean implements Serializable {
	...
	public void guardarPro01Frm01() {
		try {
			...
			PrimeFaces.current().executeInitScript("PF('dlg_eje_001_1').hide();");
			cargarForularioCheckList(checkListEjecucion);
		} catch (Exception e) {
			e.printStackTrace();
	...
	public void guardarPro02Frm01() {
		try {
			...
			PrimeFaces.current().executeInitScript("PF('dlg_eje_001_2').hide();");
			cargarForularioCheckList(checkListEjecucion);
		} catch (Exception e) {
			e.printStackTrace();
	...
	public void guardarPro03Frm01() {
		try {
			...
			PrimeFaces.current().executeInitScript("PF('dlg_eje_001_3').hide();");
			cargarForularioCheckList(checkListEjecucion);
		} catch (Exception e) {
			e.printStackTrace();
			System.out.println("Error :Método guardarPro01Frm01 " + " " + e.getMessage());
	...
	public void guardarPro04Frm01() {
		try {
			...
			PrimeFaces.current().executeInitScript("PF('dlg_eje_001_4').hide();");
			cargarForularioCheckList(checkListEjecucion);
		} catch (Exception e) {
			e.printStackTrace();
			System.out.println("Error :Método guardarPro01Frm01 " + " " + e.getMessage());
	...
	public void guardarPro05Frm01() {
		try {
			...
			PrimeFaces.current().executeInitScript("PF('dlg_eje_001_5').hide();");
			cargarForularioCheckList(checkListEjecucion);
		} catch (Exception e) {
			e.printStackTrace();
			System.out.println("Error :Método guardarPro01Frm01 " + " " + e.getMessage());
