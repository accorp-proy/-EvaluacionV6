...
public class LoginBean extends BaseBean {
	...
	public void init() {
		...
		case 1:
			PrimeFaces.current().executeScript("doGrowl('Debe ingresar usuario y contrase�a')");
			break;
		case 2:
			PrimeFaces.current()
					.executeScript("doGrowl('Verifique que su nombre de usuario y contrase�a sea el correcto')");
			break;
		}
		appMain.setErrLog(0);
	}
