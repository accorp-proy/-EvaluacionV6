...
public class ReporteFaltanteInventarioDao extends GenericDao<ReporteFaltanteInventarioEt, Long> implements IReporteFaltanteInventarioDao {

	public ReporteFaltanteInventarioDao() {
		super(ReporteFaltanteInventarioEt.class);
	}

	@TransactionAttribute(TransactionAttributeType.NOT_SUPPORTED)
	public String generar(Date fechaDesde, Date fechaHasta, Long idZona, Long idEvaluacion, Long idUsuario) {
		StoredProcedureQuery query = this.em.createNamedStoredProcedureQuery("getGenerarReporteFaltanteInv");
