...
@Entity
@Table(name = "REPORTE_EVALUACION_PLANIFICACION_ET")
@Audited
...
public class ReporteEvaluacionPlanificacionEt extends EntityBase implements Serializable {
	...
	@Id
	@SequenceGenerator(name = "sec_reporte_evaluacion_planificacion_et", sequenceName = "seq_reporte_evaluacion_planificacion_et", allocationSize = 1, initialValue = 1)
	@GeneratedValue(generator = "sec_reporte_evaluacion_planificacion_et", strategy = GenerationType.SEQUENCE)
	@Column(name = "id_reporte_evaluacion_planificacion")
	private Long idReporteEvaluacionPlanificacion;
	...
	public ReporteEvaluacionPlanificacionEt() {
		this.dias = 0L;
		this.nroVisita = 0L;
		this.idAgencia = 0L;
		this.diasAnioA = 0L;
	...
	public Long getIdReporteEvaluacionPlanificacion() {
		return idReporteEvaluacionPlanificacion;
	}

	public void setIdReporteEvaluacionPlanificacion(Long idReporteEvaluacionPlanificacion) {
		this.idReporteEvaluacionPlanificacion = idReporteEvaluacionPlanificacion;
	}
	...
	public boolean equals(Object obj) {
		...
		if (obj instanceof ReporteEvaluacionPlanificacionEt) {

			ReporteEvaluacionPlanificacionEt other = (ReporteEvaluacionPlanificacionEt) obj;
			if (this.idReporteEvaluacionPlanificacion == null)
				return this == other;

			return this.idReporteEvaluacionPlanificacion.equals(other.idReporteEvaluacionPlanificacion);
		}
		return false;
	}
