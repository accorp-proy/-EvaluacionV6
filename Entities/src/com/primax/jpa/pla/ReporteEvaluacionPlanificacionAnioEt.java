...
@Entity
@Table(name = "REPORTE_EVALUACION_PLANIFICACION_ANIO_ET")
@Audited

@NamedStoredProcedureQuery(name = "getGenerarReportePlanificacionAnio", procedureName = "fun_generar_rpt_evaluacion_planificacion_anio", resultClasses = ReporteEvaluacionPlanificacionAnioEt.class, parameters = {
		...
		@StoredProcedureParameter(mode = ParameterMode.IN, type = Date.class, name = "fechaAnterior"),
...
public class ReporteEvaluacionPlanificacionAnioEt extends EntityBase implements Serializable {
	...
	@Id
	@SequenceGenerator(name = "sec_reporte_evaluacion_planificacion_anio_et", sequenceName = "seq_reporte_evaluacion_planificacion_anio_et", allocationSize = 1, initialValue = 1)
	@GeneratedValue(generator = "sec_reporte_evaluacion_planificacion_anio_et", strategy = GenerationType.SEQUENCE)
	@Column(name = "id_reporte_evaluacion_planificacion_anio")
	private Long idReporteEvaluacionPlanificacionAnio;
	...
	public ReporteEvaluacionPlanificacionAnioEt() {
		this.dias = 0L;
		this.nroVisita = 0L;
		this.idAgencia = 0L;
		this.color = "#FFFFFF";
	...
	public Long getIdReporteEvaluacionPlanificacionAnio() {
		return idReporteEvaluacionPlanificacionAnio;
	}

	public void setIdReporteEvaluacionPlanificacionAnio(Long idReporteEvaluacionPlanificacionAnio) {
		this.idReporteEvaluacionPlanificacionAnio = idReporteEvaluacionPlanificacionAnio;
	}
	...
	public boolean equals(Object obj) {
		...
		if (obj instanceof ReporteEvaluacionPlanificacionAnioEt) {

			ReporteEvaluacionPlanificacionAnioEt other = (ReporteEvaluacionPlanificacionAnioEt) obj;
			if (this.idReporteEvaluacionPlanificacionAnio == null)
				return this == other;

			return this.idReporteEvaluacionPlanificacionAnio.equals(other.idReporteEvaluacionPlanificacionAnio);
		}
		return false;
	}
