...
@Entity
@Table(name = "FALTANTE_TOP_NEGATIVO_ET")
@Audited

public class FaltanteTopNegativoEt extends EntityBase implements Serializable {

	private static final long serialVersionUID = -3318332355036766787L;

	@Id
	@SequenceGenerator(name = "sec_faltante_top_negativo_et", sequenceName = "seq_faltante_top_negativo_et", allocationSize = 1, initialValue = 1)
	@GeneratedValue(generator = "sec_faltante_top_negativo_et", strategy = GenerationType.SEQUENCE)
	@Column(name = "id_faltante_top_negativo")
	private Long idfaltanteTopNegativo;
	...
	public boolean equals(Object obj) {
		if (obj instanceof FaltanteTopNegativoEt) {
			FaltanteTopNegativoEt other = (FaltanteTopNegativoEt) obj;
			if (this.idfaltanteTopNegativo == null)
				return this == other;

			if (this.idfaltanteTopNegativo.equals(other.idfaltanteTopNegativo))
				return true;
		}
		return false;
